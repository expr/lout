...
var internals = {
    defaults: {
        engines: {
            html: {
                // Work around plugin.views nullifying the module
                get module() {
                    return Handlebars;
                }
            }
...
exports.register = function (plugin, options, next) {
    ...
    // Hoek doesn't manage to clone handlebars properly
    settings.engines = options.engines || internals.defaults.engines;
...
internals.getParamsData = function (param, name) {
    ...
    var data = {
        ...
        required: param.flags ? param.flags.presence === 'required' : null,
    ...
    if (data.type === 'object' && param.children) {
        ...
        if (param.rules) {
            ...
            param.rules.forEach(function (rule) {
                ...
                data.rules[internals.capitalize(rule.name)] = rule.arg;
            });
        }
